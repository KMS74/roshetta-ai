      ...
      >
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-12 shadow-sm border border-slate-100 dark:border-slate-800 prose prose-slate dark:prose-invert max-w-none transition-colors">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            This service is for informational purposes only. It is not intended
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            While we strive for accuracy, the extraction of medical data from
            handwritten text is inherently complex and may contain errors.
            Always verify information with a medical professional.
          </p>
        </div>
      </motion.div>
    </main>
