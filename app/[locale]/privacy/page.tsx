      ...
      >
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-12 shadow-sm border border-slate-100 dark:border-slate-800 prose prose-slate dark:prose-invert max-w-none transition-colors">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            At Roshetta.AI, we use state-of-the-art encryption and processing
            techniques to ensure your medical data is handled with the highest
            level of security. We do not store your prescription images or
            personal medical data on our servers after processing is complete.
          </p>
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            We only collect the data necessary to provide the service. This
            includes the image you upload for transient processing by the Gemini
            AI engine.
          </p>
        </div>
      </motion.div>
