  ...
  return (
    <div className="relative shrink-0">
      <button
        ...
        className="flex items-center gap-1.5 sm:gap-2 rounded-xl bg-slate-100 dark:bg-slate-800 px-3 py-2 sm:px-4 text-sm font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors focus-visible:ring-2 focus-visible:ring-brand-teal focus-visible:outline-none disabled:opacity-60"
      >
